...
\begin{DoxyCompactList}\small\item\em Given two matrices A and b, solves the linear system of equations assuming the form Ax = b. \item\end{DoxyCompactList}\item 
int \hyperlink{_matrix_functions_8h_acc756ba99d15afd1e9f4c5f04e985e02}{simplex} (\hyperlink{class_matrix}{Matrix} \&A, \hyperlink{class_matrix}{Matrix} \&b)
...
\begin{DoxyCode}
    ...
    cout << P << endl;
\end{DoxyCode}
 \hypertarget{_matrix_functions_8h_acc756ba99d15afd1e9f4c5f04e985e02}{
\index{MatrixFunctions.h@{MatrixFunctions.h}!simplex@{simplex}}
\index{simplex@{simplex}!MatrixFunctions.h@{MatrixFunctions.h}}
\subsubsection[{simplex}]{\setlength{\rightskip}{0pt plus 5cm}int simplex ({\bf Matrix} \& {\em A}, \/  {\bf Matrix} \& {\em b})}}
\label{_matrix_functions_8h_acc756ba99d15afd1e9f4c5f04e985e02}
